...
contract SCPNSBase is 
     ...
     */
    function __SCPNSBase_init(string memory name_, string memory symbol_, string memory baseURI_) internal initializer {
        __Pausable_init_unchained();
        __AccessControlEnumerable_init_unchained();
        __SCPNSBase_init_unchained(name_, symbol_, baseURI_);
    }
    ...
    */
    ...
    virtual 
    {
        ...
        require(_id2Names[tokenId] == bytes32(0), "SCPNSBase: tokenId is exists.");
    ...
    /**
      @dev remove a token from all tokens
    */
    function _removeTokenFromAllTokens(uint256 tokenId) internal {
