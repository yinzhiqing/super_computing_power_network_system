...
{
    event Set(uint256 indexed index, uint256 indexed parameterId,  uint256 indexed tokenId, uint256 preBlockNumber, uint256 selfPreBlockNumber, uint256 execTime, uint256 taskId);

    function set(uint256 tokenId, uint256 start, uint256 end, uint256 parameterId, uint256 taskId) external;

    function isController(address controller) external view returns(bool);
    function exctimeOf(uint256 parameterId, uint256 tokenId) external view returns(uint256);
