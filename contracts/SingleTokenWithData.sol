 ...
 */
contract SingleTokenWithData is 
    Initializable, 
    ContextUpgradeable, 
    ...
    function initialize(string memory name, string memory symbol, string memory baseTokenURI) public virtual initializer {
        __SingleTokenWithData_init(name, symbol, baseTokenURI);
    }
    /**
     ...
     * See {ERC721-tokenURI}.
     */
    function __SingleTokenWithData_init(string memory name, string memory symbol, string memory baseTokenURI) internal initializer {
        ...
        __SingleTokenWithData_init_unchained(baseTokenURI);
    }

    function __SingleTokenWithData_init_unchained(string memory baseTokenURI) internal initializer {
    ...
    function mint(address to, uint256 tokenId, string memory datas) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "SingleTokenWithData: must have minter role to mint");
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "SingleTokenWithData: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "SingleTokenWithData: must have pauser role to unpause");
        _unpause();
    }
    ...
    */
    ...
    function updateTokenManager(address manager) public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "SingleTokenWithData: must have admin role to grant");
        require(!paused(), "SingleTokenWithData: token transfer while paused");
        require(_tokenManager != manager, "SingleTokenWithData: this manager already exists.");
