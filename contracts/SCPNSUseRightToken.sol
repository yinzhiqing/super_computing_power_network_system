...
contract SCPNSUseRightToken is
   ...
   ISCPNSUseRightToken 
   {
     ...
     ISCPNSComputilityVM internal _computilityVMIf;
    ...
    function initialize(address computilityVMAddr_) public virtual initializer {
        __SCPNSBase_init("SCPNSUseRightToken", "SCPNSUseRightToken", "");
        __SCPNSUseRightToken_init(computilityVMAddr_);
    }
    /**
     ...
     */
    function __SCPNSUseRightToken_init(address contract_) internal initializer {
        __SCPNSUseRightToken_init_unchained(contract_);
    }

    function __SCPNSUseRightToken_init_unchained(address contract_) internal initializer {
        _unitType("computilityvm");
        computilityVMAddr = contract_;
        _computilityVMIf = ISCPNSComputilityVM(contract_);
    }
